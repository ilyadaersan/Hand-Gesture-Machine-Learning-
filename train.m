...
Base  = strcat(current_folder,'\train'); % train or test
      ...
      for rep = 1:5 % 5 repetition
           ...
           for i =  0: 100: 7500 % sliding window approach
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                MeanAbsoluteValue1 = mean(abs(ch1));
                MeanAbsoluteValue2 = mean(abs(ch2));
                MeanAbsoluteValue3 = mean(abs(ch3));
                MeanAbsoluteValue4 = mean(abs(ch4));
                
                D1 = [];
                d1 = [D1  MeanAbsoluteValue1, MeanAbsoluteValue2, MeanAbsoluteValue3, MeanAbsoluteValue4];
                
                StandardDeviation1 = std(ch1);
                StandardDeviation2 = std(ch2);
                StandardDeviation3 = std(ch3);
                StandardDeviation4 = std(ch4);
                
                D2 = [];
                d2 = [D2 StandardDeviation1,StandardDeviation2,StandardDeviation3,StandardDeviation4];
                ...
                D3 = [];
                d3 = [D3 Varience1,Varience2,Varience3,Varience4];
